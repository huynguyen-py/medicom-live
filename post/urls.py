...
urlpatterns = [
    ...
    path('<int:Post_Id>/', views.post_detail.as_view(), name="post_detail"),
    ...
    path('<int:pk>', views.LikeView, name="like_post"),
    # path('<int:pk>/', views.LikeCommentView, name="like_comment"),
